...
import com.abhaybmicoctest.app.DashboardActivity;
...
import com.abhaybmicoctest.app.glucose.Activity_ScanList;
import com.abhaybmicoctest.app.heightweight.Principal;
import com.abhaybmicoctest.app.hemoglobin.util.BluetoothUtils;
import com.abhaybmicoctest.app.hemoglobin.util.StringUtils;
import com.abhaybmicoctest.app.printer.esys.pridedemoapp.Act_Main;
...
import static com.abhaybmicoctest.app.hemoglobin.Constants.SCAN_PERIOD;
import static com.abhaybmicoctest.app.hemoglobin.Constants.SERVICE_UUID;
...
public class MainActivity extends AppCompatActivity implements GattClientActionListener,TextToSpeech.OnInitListener, View.OnClickListener {
    ...
    private void bindEvents() {
        ...
        txtmainOximeter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                context.startActivity(new Intent(MainActivity.this, com.abhaybmicoctest.app.oximeter.MainActivity.class));
            }
        });
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.txtmainpulseoximeter:
                Toast.makeText(context, "clicked", Toast.LENGTH_SHORT).show();
                context.startActivity(new Intent(this, com.abhaybmicoctest.app.oximeter.MainActivity.class));
                break;
