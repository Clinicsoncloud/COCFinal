...
public class Act_BTDiscovery extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		Log.e(TAG, "btdiscovery oncreate ..........");
		try {
			...
			e.printStackTrace();
			Log.e(TAG, "btdiscovery oncreate catch");
		}
		Log.e(TAG, "btdiscovery after try");
		
		btn_Scan = (Button)findViewById(R.id.scan_but);
		btn_Scan.setOnClickListener(this);
		
		btn_Exit = (Button)findViewById(R.id.close_but);
	...
	//Exit confirmation dialog box
		public void dlgExit() {
			...
			alertDialogBuilder.setMessage(
					"Do you want to exit from Pride Demo application");
