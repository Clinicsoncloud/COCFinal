...
import com.abhaybmicoc_test.app.utils.Utils;
...
public class OtpLoginScreen extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onPause() {
        super.onPause();
        //Close the tts engine to avoide the runtime exception from tts engine
        try {
            if (tts != null) {
                tts.stop();
                tts.shutdown();
//            Toast.makeText(getApplicationContext(), "TTS Stoped", Toast.LENGTH_SHORT).show();
    ...
    private void speakOut() {
        String text = "Welcome to Clinics on Cloud Please Enter Mobile Number";
