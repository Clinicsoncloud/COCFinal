...
public class PrintPriviewScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtphysique = findViewById(R.id.tv_physique);
        txtweight = findViewById(R.id.tv_weight);
        txtprotine = findViewById(R.id.tv_protine);
        ...
        txtbodyfat = findViewById(R.id.tv_body_fat);
        ...
        txthelthscore = findViewById(R.id.tv_helth_score);
        txtskemus = findViewById(R.id.tv_skeletel_muscle);
        txtsubfat = findViewById(R.id.tv_subcutaneous_fat);
...
//                asynctask.execute(0);
        ...
        TextView txtweight = findViewById(R.id.tv_weight);
        ...
        TextView txtphysique = findViewById(R.id.tv_physique);
        ...
        TextView txtbodyfat = findViewById(R.id.tv_body_fat);
        TextView txtmuscle_mass = findViewById(R.id.txtmuscle_mass);
        TextView txtbone_mass = findViewById(R.id.txtbone_mass);
        TextView txtprotine = findViewById(R.id.tv_protine);
        TextView txtBMR = findViewById(R.id.txtBMR);
        TextView txtmeta_age = findViewById(R.id.txtmeta_age);
        TextView txthelthscore = findViewById(R.id.tv_helth_score);
        TextView txtskemus = findViewById(R.id.tv_skeletel_muscle);
        TextView txtsubfat = findViewById(R.id.tv_subcutaneous_fat);
    ...
    public void dlgEnterText() {
        ...
        TextView txtphysique = dialog.findViewById(R.id.tv_physique);
        TextView txtweight = dialog.findViewById(R.id.tv_weight);
        TextView txtprotine = dialog.findViewById(R.id.tv_protine);
        ...
        TextView txtbodyfat = dialog.findViewById(R.id.tv_body_fat);
        ...
        TextView txthelthscore = dialog.findViewById(R.id.tv_helth_score);
        TextView txtskemus = dialog.findViewById(R.id.tv_skeletel_muscle);
        TextView txtsubfat = dialog.findViewById(R.id.tv_subcutaneous_fat);
