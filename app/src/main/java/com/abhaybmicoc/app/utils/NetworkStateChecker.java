...
import com.abhaybmicoc.app.SQLiteDatabase.DatabaseHelper;
...
public class NetworkStateChecker {
  ...
  /*  //context and database helper object
    ...
    //region checkNetworkandSave
    private void checkNetworkandSave() {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        saveName(
                                ...
                                cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_PATIENTID))
                        );
