    ...
    private final BroadcastReceiver mUsbReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            switch (intent.getAction()) {
                case com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_USB_PERMISSION_GRANTED: // USB PERMISSION GRANTED
                    Toast.makeText(context, "USB Ready", Toast.LENGTH_SHORT).show();
                    break;
                case com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_USB_PERMISSION_NOT_GRANTED: // USB PERMISSION NOT GRANTED
                    Toast.makeText(context, "USB Permission not granted", Toast.LENGTH_SHORT).show();
                    break;
                case com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_NO_USB: // NO USB CONNECTED
                    Toast.makeText(context, "No USB connected", Toast.LENGTH_SHORT).show();
                    break;
                case com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_USB_DISCONNECTED: // USB DISCONNECTED
                    Toast.makeText(context, "USB disconnected", Toast.LENGTH_SHORT).show();
                    break;
                case com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_USB_NOT_SUPPORTED: // USB NOT SUPPORTED
...
//                        mUsbReceiver.abortBroadcast();
    ...
    private void startService(Class<?> service, ServiceConnection serviceConnection, Bundle extras) {
        if (!com.abhaybmicoc.app.heightweight.HeightUsbService.SERVICE_CONNECTED) {
    ...
    private void setFilters() {
        ...
        filter.addAction(com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_USB_PERMISSION_GRANTED);
        filter.addAction(com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_NO_USB);
        filter.addAction(com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_USB_DISCONNECTED);
        filter.addAction(com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_USB_NOT_SUPPORTED);
        filter.addAction(com.abhaybmicoc.app.heightweight.HeightUsbService.ACTION_USB_PERMISSION_NOT_GRANTED);
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case com.abhaybmicoc.app.heightweight.HeightUsbService.MESSAGE_FROM_SERIAL_PORT:
                    String data = (String) msg.obj;
                    mActivity.etManualheight.append(data);
                    Toast.makeText(mActivity, data, Toast.LENGTH_SHORT).show();
                    break;
                case com.abhaybmicoc.app.heightweight.HeightUsbService.CTS_CHANGE:
                    Toast.makeText(mActivity, "CTS_CHANGE", Toast.LENGTH_LONG).show();
                    break;
                case com.abhaybmicoc.app.heightweight.HeightUsbService.DSR_CHANGE:
                    Toast.makeText(mActivity, "DSR_CHANGE", Toast.LENGTH_LONG).show();
                    break;
                case com.abhaybmicoc.app.heightweight.HeightUsbService.SYNC_READ:
